...
# Resource capacities
EDGE_SERVER_CPU_CAPACITY = 3.94*1e9  # cycles
...
MIN_NUM_DEVICES = 20
MAX_NUM_DEVICES = 20 # Quite excessive, but we need to test the limits of the simulator

# Tree parameters
TREE_STORAGE_BUDGET = 1e7 # 10 million nodes, if more than this, RAM explodes :(
TREE_CONVERGENCE_THRESHOLD = 0.001
TREE_CONVERGENCE_WINDOW = 50
EXPLORATION_BONUS = 0.8
NUM_SUBACTIONS = 5
NUM_ITERATIONS = 50000
DISCOUNT_FACTOR = 0.99  # Discount factor for rewards in backpropagation
