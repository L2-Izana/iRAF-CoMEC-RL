...
#     Args:
#         files_info (list of dict or str): Either a list of dicts where each dict has:
#             - 'file_path': path to the metrics file
#             - 'label': label for the curve
#             - optionally: 'num_devices', 'num_tasks', 'num_bs', 'num_es'
#             OR a single string path to a metrics file
#         window_size (int): Window size for simple moving average
#         title (str): Plot title
#     """
#     plt.figure(figsize=(12, 6))

#     # Convert single file path to list format if needed
#     if isinstance(files_info, str):
#         files_info = [{'file_path': files_info, 'label': 'Metrics'}]
...
# plot_multiple_smoothed_metrics("D:/Research/IoT/iRAF-CoMEC-RL/latency_energy_metrics1748705150.4204001.txt", window_size=200)
